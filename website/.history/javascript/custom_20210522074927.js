...
function reciptController() {
    ...
    if(group_book.lodging != null) {
        if(group_book.lodging != null) {
            ...
            makeDiv.innerHTML += `
            <p class="col-2">Total Nights: <b>${dateDiff(group_book.startdate, group_book.enddate)}</b></p>
            <p class="col-2">Total Price: <b>${formatter.format(group_book.lodging.totalprice())}</b></p>`;
        }
    }
}
