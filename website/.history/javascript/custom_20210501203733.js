            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                for (let i = 0; i < app_elements.length; i++) {
                    if (app_elements[i]["Employee ID"]) {
                        ...
                        document.getElementById(`app_cost_${app_id}`).innerHTML += `Employee awaiting approval(#eID-${app_elements[i]["Employee ID"]})`;
                        document.getElementById(`app_desc_${app_id}`).innerHTML += `Employee awaiting approval(#eID-${app_elements[i]["Employee ID"]})`;
                        document.getElementById(`app_edate_${app_id}`).innerHTML += `Employee awaiting approval(#eID-${app_elements[i]["Employee ID"]})`;
                        document.getElementById(`app_etype_${app_id}`).innerHTML += `Employee awaiting approval(#eID-${app_elements[i]["Employee ID"]})`;
                        document.getElementById(`app_loc_${app_id}`).innerHTML += `Employee awaiting approval(#eID-${app_elements[i]["Employee ID"]})`;
                        document.getElementById(`app_gformat_${app_id}`).innerHTML += `Employee awaiting approval(#eID-${app_elements[i]["Employee ID"]})`;
                        document.getElementById(`app_just_${app_id}`).innerHTML += `Employee awaiting approval(#eID-${app_elements[i]["Employee ID"]})`;
                    }
                }
            } else if (this.readyState == 4 && this.status == 400) {
