                    ...
                    if (employee_work[i]["Application ID"]) {
                        ...
                        if (employee_work[i]["Date Completed"] != null) {
                            ...
                            <li id="approve_item_${employee_work[i]["Work ID"]}">
                                ...
                                <span>
                                    <button type="submit" disabled="disabled" onload="enable_by_role(position_holder);" id="requestorbtn_${employee_work[i]["Work ID"]}_dept" class="btn btn-outline-success">Request Additional Information(depthead)
