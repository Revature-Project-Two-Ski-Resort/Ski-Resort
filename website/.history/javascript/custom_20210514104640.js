...
let group_book = new Object();
    group_book.id = 0;
    group_book.pin = 0000;
    group_book.offseason.camping.sites.greentree.id = 0;
    group_book.offseason.camping.sites.greentree.name = "green tree";
    group_book.offseason.camping.sites.greentree.danger = 3;
    group_book.offseason.camping.sites.greentree.ages = [6, 200];
    group_book.offseason.camping.sites.greentree.price = 20.00;
    group_book.offseason.camping.sites.greentree.startdate = 5/10/2021;
    group_book.offseason.camping.sites.greentree.enddate = 5/11/2021;
    group_book.users = new Object();
        group_book.users.primaryuser = new Object();
            ...
            group_book.users.primaryuser.activities.greentree = new Object();
                activities.offseason.camping.sites.greentree.id = 0;
                activities.offseason.camping.sites.greentree.name = "green tree";
                activities.offseason.camping.sites.greentree.danger = 3;
                activities.offseason.camping.sites.greentree.ages = [6, 200];
                activities.offseason.camping.sites.greentree.price = 20.00;
                activities.offseason.camping.sites.greentree.startdate = 5/10/2021;
                activities.offseason.camping.sites.greentree.enddate = 5/11/2021;
