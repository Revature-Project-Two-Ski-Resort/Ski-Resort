...
function addPerson(person, personId) {
    if (group_book.users[personId] == null) {
        group_book.users[personId] = new Object;
    }
    group_book.users[personId].firstname = "";
    group_book.users[personId].middlename = "";
    group_book.users[personId].lastname = "";
    group_book.users[personId].age = 1;
    group_book.users[personId].lvl = 1;
