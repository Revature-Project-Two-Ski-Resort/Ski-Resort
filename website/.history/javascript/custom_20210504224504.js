                            ...
                            <li>
                                <div class="card ${my_most_urgent}">
                                    <div class="row">
                                        <div class="col-7">
                                            <div class="card-body">
                                                <div id="msg_loader${employee_work[i]["Application ID"]}"></div>
                                ...
                                <button type="submit" id="approverbtn_${employee_work[i]["Work ID"]}" onclick="approve_app(${employee_work[i]["Work ID"]}, ${employee_work[i]["Application ID"]});" class="btn btn-outline-success">Approve Application
...
function approve_app(work_id_holder, app_id_holder) {
    if (app_id_holder) {
        update_app = new Object();
        update_app.urgency_level = 10;
        ...
        url = `http://localhost:5000/users/${your_data["Employee ID"]}/work/ + app_id`;
        xhttp.open("GET", url, true);
        xhttp.send();
    } else {
