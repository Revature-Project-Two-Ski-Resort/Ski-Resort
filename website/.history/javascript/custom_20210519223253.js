...
function addpersonelement() {
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            <label for="prime_fname">*First Name</label>
            <input type="text" class="form-control" id="prime_fname" name="prime_fname" required>
            <div class="invalid-feedback">
                Please type a valid First Name.
            </div>
        </div>
        <div class="form-group col-md-4">
            <label for="prime_mname">M. Initial</label>
            <input type="text" class="form-control" id="prime_mname" name="prime_mname">
            <div class="invalid-feedback">
                Please type a valid middle name.
            </div>
        </div>
        <div class="form-group col-md-4">
            <label for="prime_lname">*Last Name</label>
            <input type="text" class="form-control" id="prime_lname" name="prime_lname" required>
            <div class="invalid-feedback">
    ...
    <div class="form-row">
        <div class="form-group col-md-3">
            <label for="primaryAge">Age</label>
            <input type="number" min=0 max=150 step="1" placeholder="Age" class="form-control" id="primaryAge" name="primaryAge" aria-label="Please enter your age" required />
            <div class="invalid-feedback">
                Please enter a valid age.
            </div>
        </div>
        <div class="form-group col-sm-9">
            <label for="primarySkill">Skill Level(1-5)</label>
            <div class="form-row">
                <input type="number" min=1 max=5 step="1" placeholder="5=expert" value=1 class="form-control col-md-7" id="primarySkill" name="primarySkill" aria-label="Please enter your skill level" />
                <div class="col-md-5">
