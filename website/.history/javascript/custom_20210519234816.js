...
function addpersonelement() {
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <input oninput="addPerson(this.value, 'user${itemcounter}', 'firstname');" type="text" class="form-control" id="firstname${itemcounter}" name="firstname${itemcounter}" required>
        ...
        <div class="form-group col-md-4">
            ...
            <input oninput="addPerson(this.value, 'user${itemcounter}', 'middlename');" type="text" class="form-control" id="middlename${itemcounter}" name="middlename${itemcounter}">
            <div class="invalid-feedback">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" id="lastname${itemcounter}" name="lastname${itemcounter}" required>
            <div class="invalid-feedback">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-sm-9">
            ...
            <div class="form-row">
                ...
                <div class="col-md-5">
                    <button onclick="removeroomelement('nextperson${itemcounter}', 'user${itemcounter}', 'person-price');" type="button" class="btn btn-danger">
...
function removepersonelement(roomitem, roomId, myformPrice){
    ...
    console.log("price after remove");
    console.log(formatter.format(group_book.totalprice()));
