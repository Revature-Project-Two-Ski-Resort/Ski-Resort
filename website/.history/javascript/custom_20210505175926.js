                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="card-body">
                                        ...
                                        <textarea id="my_res_text_${response_holder[i]["Info ID"]}" oninput="block_deny(this, 'requestorbtn_${response_holder[i]["Work ID"]}');" class="card-text" cols=40 rows=5 maxlength=255></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
