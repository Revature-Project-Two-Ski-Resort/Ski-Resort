...
function disable_type(disable_feat, my_val) {
    if (my_val.value == "courses" || "certification preparation classes" || "certification" || "other") {
        document.getElementById(disable_feat).selected = 1;
    } else {
        document.getElementById(disable_feat).selected = 0;
    }
}
