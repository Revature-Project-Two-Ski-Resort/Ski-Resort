...
Object.keys(group_book).forEach(function (itemPrice) {
    // do something with data[key]
  });
// Loop through the group object and find everywhere that a price exists and adds them up in total price
var priceValidation = Object.keys(group_book).forEach(function (itemPrice) {
    console.log("find the value of itemPrice:");
    console.log(itemPrice);
    //is there a price?
    if(itemPrice.price){
        console.log("this has a price");
    } else {
        console.log("This does not have a price");
    }
});
