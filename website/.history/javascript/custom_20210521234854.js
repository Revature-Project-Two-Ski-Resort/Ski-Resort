...
function addpersonelement(iterateObject, elemID) {
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            ...
            <input value="${iterateObject.middlename}" maxlength=4 oninput="addPerson(this.value, '${elemID}', 'middlename');" type="text" class="form-control form-element" id="middlename${itemcounter}" name="middlename${itemcounter}">
            <div class="invalid-feedback">
        ...
        <div class="form-group col-md-4">
            ...
            <input value="${iterateObject.lastname}" type="text" oninput="addPerson(this.value, '${elemID}', 'lastname');" maxlength=35 class="form-control form-element" id="lastname${itemcounter}" name="lastname${itemcounter}" required>
            <div class="invalid-feedback">
