...
function reciptController() {
    ...
    if(group_book.services != null) {
        ...
        makeDiv.innerHTML += `
        <p class="col-4">Total Price: <b>${formatter.format(group_book.services.totalprice())}</b></p>`;
    }
    if(group_book.activities != null) {
        ...
        makeDiv.innerHTML += `
        <p class="col-4">Total Price: <b>${formatter.format(group_book.activities.totalprice())}</b></p>`;
    }
}
