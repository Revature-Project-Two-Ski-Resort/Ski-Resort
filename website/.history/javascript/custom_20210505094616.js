                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Approval for applicationID(#${response_holder[i]["Application ID"]})</p>
                                        <h5 class="card-title">Date submitted:</h5>
                                        <p class="card-text">${response_holder[i]["Date Received"]}</p>
                                        <h5 class="card-title">Date Approved:</h5>
                                        <p class="card-text"></p>
                                        <h5 class="card-title">Reason:</h5>
                                        <textarea id="textarea_${response_holder[i]["Application ID"]}" class="card-text" cols=40 rows=5 maxlength=255></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
