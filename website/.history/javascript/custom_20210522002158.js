...
function popPeople(iterateObject) {
    Object.keys(iterateObject).forEach(function (itemPrice) {
        ...
        if(itemPrice != "primaryuser" && itemPrice != "totalprice") {
            ...
            document.getElementById('prime_fname').value = iterateObject[itemPrice];
            document.getElementById('prime_mname').value = iterateObject[itemPrice];
            document.getElementById('prime_lname').value = iterateObject[itemPrice];
            document.getElementById('primaryemail').value = iterateObject[itemPrice];
            document.getElementById('primaryAge').value = iterateObject[itemPrice];
            document.getElementById('primarySkill').value = iterateObject[itemPrice];
        }
    });
}
