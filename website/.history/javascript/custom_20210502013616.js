                    ...
                    if (employee_work[i]["Application ID"]) {
                        ...
                        if (employee_work[i]["Date Completed"] != null) {
                            ...
                            <li>
                                    ...
                                    <div class="row">
                                        <div class="col-7">
                                            <div class="card-body">
                                                ...
                                                <textarea onchange="block_deny(this, the_denied);" class="card-text" cols="40" rows="5" maxlength="255">${my_desc}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="card-body">
                                ...
                                <button type="submit" name="denier" id="denier" class="btn btn-outline-danger">Deny Request
...
function block_deny(blocker, the_denied) {
    if (document.getElementById(blocker).value) {
