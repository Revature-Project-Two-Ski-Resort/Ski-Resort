...
(function() {
    ...
    window.addEventListener('load', function() {
        ...
        if(group_book.totalprice() > 20) {
            $("#cartItems").html(`
            <button class="btn btn-primary" onclick="startbook('confirm-book.html');"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
