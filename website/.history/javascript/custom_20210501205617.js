            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                for (let i = 0; i < app_elements.length; i++) {
                    if (app_elements[i]["Employee ID"]) {
                        ...
                        document.getElementById(`app_edate_${app_id}`).innerHTML = `${format_my_date.getUTCDay()} ${format_my_date.getUTCMonth+1}/${format_my_date.getUTCDate}/${format_my_date.getUTCFullYear}`;
