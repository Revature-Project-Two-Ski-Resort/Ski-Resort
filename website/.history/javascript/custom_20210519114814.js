...
let lodging = new Object();
    lodging.lodgename = new Object();
        //room name
        lodging.lodgename["King Suite"] = new Object();
            lodging.lodgename["King Suite"].name = "King Suite";
            lodging.lodgename["King Suite"].price = 105.00;
            lodging.lodgename["King Suite"].viewtype = "non-mountain";
        //room name
        lodging.lodgename["Single King"] = new Object();
            lodging.lodgename["Single King"].name = "Single King";
            lodging.lodgename["Single King"].price = 80.00;
            lodging.lodgename["Single King"].viewtype = "non-mountain";
        //room name
        lodging.lodgename["Double Queen"] = new Object();
            lodging.lodgename["Double Queen"].name = "Double Queen";
            lodging.lodgename["Double Queen"].price = 70.00;
            lodging.lodgename["Double Queen"].viewtype = "non-mountain";
        //room name
        lodging.lodgename["Mountain View King Suite"] = new Object();
            lodging.lodgename["Mountain View King Suite"].name = "Mountain View King Suite";
            lodging.lodgename["Mountain View King Suite"].price = 60.00;
            lodging.lodgename["Mountain View King Suite"].viewtype = "non-mountain";
        //number of rooms
...
function addLodge() {
    if(lodging.reservation.grouprooms.room.roomSize) {
        group_book["room"+lodgeCounter] = lodging.reservation.grouprooms.roomname;
        lodgeCounter++;
    }
}
