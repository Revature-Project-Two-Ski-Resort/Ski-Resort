                                    ...
                                    <div class="row">
                                        <div class="col-7">
                                            <div class="card-body">
                                                ...
                                                <button type="submit" name="" id="" class="btn btn-outline-success">Request Additional Information</button>
                                            ...
                                            <button type="submit" name="" id="" class="btn btn-outline-danger">Deny Request</button>
                                        </div>
                                        <div class="col-4">
                                            <div class="card-body">
                                            ...
                                            <button type="submit" name="" id="" class="btn btn-outline-success"><i class="bi bi-check-circle"></i>Approve Application</button>
                                        </div>
                                    </div>
                                </div>
                            </li>
