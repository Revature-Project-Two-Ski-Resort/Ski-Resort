                    ...
                    if (employee_work[i]["Application ID"]) {
                        ...
                        if (employee_work[i]["Date Completed"] != null) {
                            ...
                            if (your_data[0].position == "Benefits Coordinator") {
                                ...
                                <input type="range" oninput="console.log(this.value);document.getElementById('update_re_val${employee_work[i]["Application ID"]}').innerHTML = 'First Name: ('+this.value+')'" min=0 max=1000 class="card-text" name="app_cost_slider_${employee_work[i]["Application ID"]}" id="app_cost_slider_${employee_work[i]["Application ID"]}">`;
                            }
                            document.getElementById("complete_approvals").innerHTML += `
