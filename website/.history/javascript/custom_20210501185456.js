            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                for (let i = 0; i < employee_work.length; i++) {
                    if (employee_work[i]["Application ID"]) {
                        //Create work lists
                        let my_desc = "";
                        console.log(employee_work[i]["Description"] == null);
                        if (!employee_work[i]["Description"] || employee_work[i]["Description"] == null) {
                        ...
                        <div class="card w-100">
                            <div class="card-body w-100">
                                ...
                                <textarea class="card-text">${my_desc}</textarea>
            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                for (let i = 0; i < app_elements.length; i++) {
                    if (app_elements[i]["Employee ID"]) {
                        ...
                        document.getElementById(`work_app_${app_id}`).innerHTML += `Employee awaiting apporoval(#${app_elements[i]["Employee ID"]})`;
                    }
                }
            } else if (this.readyState == 4 && this.status == 400) {
