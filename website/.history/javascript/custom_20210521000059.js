...
function addpersonelement() {
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
            ...
            <input maxlength=4 oninput="addPerson(this.value, 'user${itemcounter}', 'middlename');" type="text" class="form-control" id="middlename${itemcounter}" name="middlename${itemcounter}">
            <div class="invalid-feedback">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" oninput="addPerson(this.value, 'user${itemcounter}', 'lastname');" maxlength=35 class="form-control" id="lastname${itemcounter}" name="lastname${itemcounter}" required>
            <div class="invalid-feedback">
    ...
    <div class="form-row">
        <div class="form-group col-md-3">
            ...
            <input type="number" oninput="addPerson(this.value, 'user${itemcounter}', 'age');" min=0 max=150 step="1" placeholder="Age" class="form-control" id="primaryAge${itemcounter}" name="primaryAge${itemcounter}" aria-label="Please enter your age" required />
            <div class="invalid-feedback">
    ...
    makeDiv.setAttribute("class", "form-group newElem p-3 form-element");
