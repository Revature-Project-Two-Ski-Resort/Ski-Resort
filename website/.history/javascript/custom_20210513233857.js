...
//totalprice: a function that will calculate the total price of all objects in the preceding object by adding all the "price" values together
//id: uniquely identifies the item
//name: names the item
//ages: array-gives an age range from 0min-200max(200means all ages)
//weather: boolean-notes that this activity is affected by the weather(true) or not(false)
            ...
            activities.offseason.trails.bike = new Object();
                ...
                activities.offseason.trails.bike.id = 0;
                    ...
                    activities.offseason.trails.bike.info = new Object();
                        ...
                        activities.offseason.trails.bike.info.west_trail.weather = true;
