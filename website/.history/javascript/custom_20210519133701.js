...
function addroomelement() {
    ...
    <div class="form-group">
        ...
        <select onchange="addLodge(this.value, 'roomerror${itemcounter}', 'room${itemcounter}')" class="custom-select" id="mtn-bed${itemcounter}" name="mtn-bed${itemcounter}" aria-label="Choose a suite" required>
