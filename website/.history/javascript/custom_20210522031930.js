...
function addroomelement(iterateObject, elemID) {
    ...
    console.log("the select val");
    console.log(iterateObject);
    document.getElementById(`mtn-bed${itemcounter}`).value = iterateObject;
}
...
function popLodge(iterateObject) {
    Object.keys(iterateObject).forEach(function (itemPrice) {
        if(typeof(iterateObject[itemPrice]) != "function") {
            console.log(iterateObject[itemPrice])
