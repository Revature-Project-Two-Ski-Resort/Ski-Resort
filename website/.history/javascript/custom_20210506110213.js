                    ...
                    if (employee_work[i]["Application ID"]) {
                        ...
                        if (employee_work[i]["Date Completed"] != null) {
                            ...
                            if (your_data[0].position == "Benefits Coordinator") {
                                ...
                                <input type="range" oninput="document.getElementById().innerHTML = 'First Name: ('+this.value')'" min=0 max=100 class="card-text" name="app_cost_re_${employee_work[i]["Application ID"]}" id="app_cost_re_${employee_work[i]["Application ID"]}">`;
                            }
                            document.getElementById("complete_approvals").innerHTML += `
