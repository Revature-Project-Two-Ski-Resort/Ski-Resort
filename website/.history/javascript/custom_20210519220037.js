...
function addPerson(person, personId) {
    ...
    group_book.users[personId].id = 0;
    group_book.users[personId].firstname = "steve";
    group_book.users[personId].middlename = "sam";
    group_book.users[personId].lastname = "john";
