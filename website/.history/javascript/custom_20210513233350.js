...
//totalprice: a function that will calculate the total price of all objects in the preceeding object by adding all the "price" values together
//id: uniquely identifies the item
//name: names the item
//ages: gives an age range
