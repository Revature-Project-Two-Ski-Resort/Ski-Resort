        ...
        if(group_book.lodging != null) {
            ...
            Object.keys(group_book.lodging).forEach(function (item) {
                if(typeof(group_book.lodging[item]) != "function") {
                    myEmail = "";
                    if(group_book.lodging[item].email){
                        myEmail = `<p class="col-4">Email: ${group_book.lodging[item].email}</p>`;
                    }
                    makeDiv.innerHTML += `
                        <div class="row m-3" style="border-bottom:1px #000000 solid">
                            <h1 class="col-12">Customer Information</h1>
                            <p class="col-4">First Name: ${group_book.lodging[item].firstname}</p>
                            <p class="col-4">Middle Initial: ${group_book.lodging[item].middlename}</p>
                            <p class="col-4">Last Name: ${group_book.lodging[item].lastname}</p>
                            ${myEmail}
                            <p class="col-4">Age: ${group_book.lodging[item].age}</p>
                            <p class="col-4">Skill Level: ${group_book.lodging[item].lvl}</p>
