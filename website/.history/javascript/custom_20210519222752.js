...
function addpersonelement() {
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" id="prime_fname" required>
            <div class="invalid-feedback">
                Please type a valid First Name.
            </div>
        </div>
        <div class="form-group col-md-4">
            <label for="inputPassword4">M. Initial</label>
            <input type="text" class="form-control" id="prime_mname">
            <div class="invalid-feedback">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" id="prime_lname" required>
            <div class="invalid-feedback">
