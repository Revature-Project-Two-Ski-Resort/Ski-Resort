...
let activities = new Object();
    ...
    activities.west_trail = new Object();
        activities.info.west_trail.id = 0;
        activities.info.west_trail.name = "west_trail";
        activities.info.west_trail.distance = 13;//in miles
        activities.info.west_trail.ages = [16, 200];
    ...
    activities.offseason.trails.hiking.info.eagle_trail = new Object();
        ...
        activities.offseason.trails.hiking.info.eagle_trail.name = "eagle_trail";
    ...
    activities.offseason.trails.hiking.info.blue_trail = new Object();
        ...
        activities.offseason.trails.hiking.info.blue_trail.name = "blue_trail";
    ...
    activities.green_trail = new Object();
        ...
        activities.green_trail.name = "green trail";
    ...
    activities.greentree = new Object();
        ...
        activities.greentree.name = "green tree";
        activities.greentree.danger = 3;
        activities.greentree.ages = [6, 200];
        activities.greentree.price = 20.00;
