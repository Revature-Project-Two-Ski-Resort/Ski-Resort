...
function addpersonelement(iterateObject) {
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <input value="${iterateObject.firstname}" maxlength=35 oninput="addPerson(this.value, 'user${itemcounter}', 'firstname');" type="text" class="form-control form-element" id="firstname${itemcounter}" name="firstname${itemcounter}" required>
