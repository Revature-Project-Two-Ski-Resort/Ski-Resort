                                    ...
                                    <div class="row">
                                        <div class="col-7">
                                            <div class="card-body">
                                                ...
                                                <textarea id="textarea_${employee_work[i]["Application ID"]}" oninput="block_deny(this, 'requestorbtn_${employee_work[i]["Work ID"]}_dept');${dis_req_func}" class="card-text" cols="40" rows="5" maxlength="255">${my_desc}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="card-body">
