...
function getTotalPrice(iterateObject, price, print, print_loc) {
    ...
    if(iterateObject["price"] != null){
        ...
        if(print) {
            if(document.getElementById(print_loc)) {
                document.getElementById(print_loc).innerHTML += `<p>Price: ${price}</p>`;
            }
        }
    }
    Object.keys(iterateObject).forEach(function (itemPrice) {
        ...
        if(print && typeof(getTotalPrice(iterateObject[itemPrice])) != "object" && typeof(getTotalPrice(iterateObject[itemPrice])) != "function") {
            if(document.getElementById(print_loc)) {
