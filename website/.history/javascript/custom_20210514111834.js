...
let group_book = new Object();
    ...
    group_book.activities = new Object();
        group_book.activities.greentree.id = 0;
        group_book.activities.greentree.name = "green tree";
        group_book.activities.greentree.danger = 3;
        group_book.activities.greentree.ages = [6, 200];
        group_book.activities.greentree.price = 20.00;
        group_book.activities.greentree.startdate = 5/10/2021;
        group_book.activities.greentree.enddate = 5/11/2021;
