...
function addpersonelement(iterateObject, elemID) {
    ...
    <div class="form-row">
        <div class="form-group col-md-3">
            ...
            <input value="${iterateObject.age}" type="number" oninput="addPerson(this.value, '${elemID}', 'age');" min=0 max=150 step="1" placeholder="Age" class="form-control form-element" id="primaryAge${itemcounter}" name="primaryAge${itemcounter}" aria-label="Please enter your age" required />
            <div class="invalid-feedback">
