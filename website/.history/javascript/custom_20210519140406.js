...
function addroomelement() {
    ...
    <div id="nextroom${itemcounter}" class="form-group">
        ...
        <div class="form-row">
            ...
            <div class="col-md-3">
                <button onclick="removeroomelement('nextroom${itemcounter}');" type="button" class="btn btn-danger">
...
function removeroomelement(roomitem){
    document.getElementById(roomitem).removeChild();
}
