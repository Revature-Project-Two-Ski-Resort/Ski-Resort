...
(function() {
    ...
    window.addEventListener('load', function() {
        ...
        var validation = Array.prototype.filter.call(forms, function(form) {
            ...
            var emailValidation = Array.prototype.filter.call(inputs, function(input) {
...
getTotalPrice(group_book)
if(group_book["totalprice"] != null){
    console.log(group_book.totalprice);
} else {
    console.log("does not have a price");
}
// Loop through the group object and find everywhere that a price exists and adds them up in total price
function getTotalPrice(iterateObject) {
    var priceValidation = Object.keys(iterateObject).forEach(function (itemPrice) {
        console.log("Start new layer");
        //does this have a value(true) or not(false)
        if(iterateObject[itemPrice] != null){
            if(itemPrice == "price") {
                console.log("this has a price");
            } else {
                getTotalPrice(iterateObject[itemPrice]);
            }
        }
    });
}
