...
function get_all_my_apps_i_filed(your_data, my_app_loader) {
    ...
    ajax.onreadystatechange = function () {
        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            document.getElementById("cal_re").innerHTML = "Total Cost("+formatter.format(total_money_cost)+") Total Projected Refund("+formatter.format(total_cost_re_all)+")Subject to change";
        } else if (this.readyState == 4 && this.status == 400) {
