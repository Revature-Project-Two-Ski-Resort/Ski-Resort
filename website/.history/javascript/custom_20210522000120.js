...
function addpersonelement(iterateObject, elemID) {
    ...
    <div class="form-row">
        ...
        <div class="form-group col-sm-9">
            ...
            <div class="form-row">
                <input value="${iterateObject.lvl}" type="number" oninput="addPerson(this.value, '${elemID}', 'lvl');" min=1 max=5 step="1" placeholder="5=expert" value=1 class="form-control col-md-7 form-element" id="primarySkill${itemcounter}" name="primarySkill${itemcounter}" aria-label="Please enter your skill level" />
                <div class="col-md-5">
