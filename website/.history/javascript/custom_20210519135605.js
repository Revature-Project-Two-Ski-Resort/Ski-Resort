...
function addroomelement() {
    ...
    <div class="form-group">
        <label for="inputAddress">Rooms</label>
        <div class="form-row">
            <select onchange="addLodge(this.value, 'roomerror', 'room0')" class="custom-select col-sm-9" id="mtn-bed" name="mtn-bed" aria-label="Choose a suite" required>
            ...
            <div class="col-md-3">
                <button onclick="removeroomelement();" type="button" class="btn btn-danger">
            ...
            <div id="roomerror" class="invalid-feedback">
