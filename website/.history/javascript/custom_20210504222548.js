                    ...
                    if (employee_work[i]["Application ID"]) {
                        ...
                        if (employee_work[i]["Date Completed"] != null) {
                            ...
                            <li>
                                ...
                                <button type="submit" id="approverbtn${employee_work[i]["Application ID"]}" onclick="approve_app(approverbtn${employee_work[i]["Application ID"]});" class="btn btn-outline-success">Approve Application
