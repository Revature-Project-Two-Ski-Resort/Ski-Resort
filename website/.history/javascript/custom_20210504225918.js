                    ...
                    if (employee_work[i]["Application ID"]) {
                        ...
                        if (employee_work[i]["Date Completed"] != null) {
                            ...
                            <li>
                                ...
                                <button type="submit" id="approverbtn_${employee_work[i]["Work ID"]}" onclick="approve_app(${employee_work[i]["Work ID"]}, ${employee_work[i]["Application ID"]}, ${employee_work[i]});" class="btn btn-outline-success">Approve Application
...
function approve_app(work_id_holder, app_id_holder, work_order) {
    if (work_id_holder) {
        update_app = new Object();
        update_app.urgency_level = work_order["Urgency level"];
