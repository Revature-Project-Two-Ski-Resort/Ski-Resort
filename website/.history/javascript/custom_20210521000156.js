...
function addpersonelement() {
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <input maxlength=35 oninput="addPerson(this.value, 'user${itemcounter}', 'firstname');" type="text" class="form-control" id="firstname${itemcounter}" name="firstname${itemcounter}" required>
