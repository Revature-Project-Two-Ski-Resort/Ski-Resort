    ...
    Object.keys(iterateObject).forEach(function (itemPrice) {
        if(print && typeof(iterateObject[itemPrice]) != "object" && typeof(iterateObject[itemPrice]) != "function") {
            if(document.getElementById(print_loc)) {
                ...
                makeP.innerHTML += `
                <h5>Primary Customer Information:</h5>
                <div id="primaryuser" class="row m-3">
                    <p class="col-4">First Name: Lamar</p>
                    <p class="col-4">Middle Name: Lamar</p>
                    <p class="col-4">Last Name: Lamar</p>
                    <p class="col-4">Email: HIdjd</p>
                    <p class="col-4">Age: HIdjd</p>
                    <p class="col-4">Skill Level: HIdjd</p>
                    <h6>Total Price: <span id="primaryuser-price">${price}</span></h6>
                </div>
                <hr class="bg-dark" />`;

            }
        }
        if(typeof(iterateObject[itemPrice]) == "object" && itemPrice != "startdate" && itemPrice != "enddate") {
