...
let lodging = new Object();
    ...
    lodging["Mountain View Single King"].id = 1;
    ...
    lodging["Mountain View Single King"].id = 2;
    ...
    lodging["Mountain View Single King"].id = 3;
    ...
    //room name
    lodging["Mountain View King Suite"] = new Object();
    lodging["Mountain View Single King"].id = 5;
        lodging["Mountain View King Suite"].name = "Mountain View King Suite";
        lodging["Mountain View King Suite"].price = 120.00;
        lodging["Mountain View King Suite"].viewtype = "mountain";
