...
let group_book = new Object();
    group_book.id = 0;
    group_book.pin = "0000";
    group_book.activities = activities;
...
function addpersonelement() {
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <input maxlength=35 oninput="addPerson(this.value, 'user${itemcounter}', 'firstname');" type="text" class="form-control form-element" id="firstname${itemcounter}" name="firstname${itemcounter}" required>
        ...
        <div class="form-group col-md-4">
            ...
            <input maxlength=4 oninput="addPerson(this.value, 'user${itemcounter}', 'middlename');" type="text" class="form-control form-element" id="middlename${itemcounter}" name="middlename${itemcounter}">
            <div class="invalid-feedback">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" oninput="addPerson(this.value, 'user${itemcounter}', 'lastname');" maxlength=35 class="form-control form-element" id="lastname${itemcounter}" name="lastname${itemcounter}" required>
            <div class="invalid-feedback">
    ...
    <div class="form-row">
        <div class="form-group col-md-3">
            ...
            <input type="number" oninput="addPerson(this.value, 'user${itemcounter}', 'age');" min=0 max=150 step="1" placeholder="Age" class="form-control form-element" id="primaryAge${itemcounter}" name="primaryAge${itemcounter}" aria-label="Please enter your age" required />
            <div class="invalid-feedback">
        ...
        <div class="form-group col-sm-9">
            ...
            <div class="form-row">
                <input type="number" oninput="addPerson(this.value, 'user${itemcounter}', 'lvl');" min=1 max=5 step="1" placeholder="5=expert" value=1 class="form-control col-md-7 form-element" id="primarySkill${itemcounter}" name="primarySkill${itemcounter}" aria-label="Please enter your skill level" />
                <div class="col-md-5">
...
function removepersonelement(roomitem, roomId, myformPrice){
    ...
    document.getElementById(myformPrice).innerHTML = formatter.format(group_book.totalprice());
...
function addroomelement() {
    ...
    <div id="nextroom${itemcounter}" class="form-group">
        ...
        <div class="form-row">
            <select onchange="addLodge(this.value, 'room${itemcounter}')" class="custom-select col-sm-9 form-element" id="mtn-bed${itemcounter}" name="mtn-bed${itemcounter}" aria-label="Choose a suite" required>
...
function getTotalPrice(iterateObject, price, print, print_loc) {
    let counter = 0;
    if(!price) {
        price = 0;
    }
    ...
    Object.keys(iterateObject).forEach(function (itemPrice) {
        if(print && typeof(iterateObject[itemPrice]) != "object" && typeof(iterateObject[itemPrice]) != "function") {
            if(document.getElementById(print_loc)) {
                let makeDiv = document.createElement("div");
                let makeP = document.createElement("p");
                makeDiv.setAttribute("class", "m-2");
                makeDiv.setAttribute("id", `data-level${counter}`);
                makeP.setAttribute("id", `data-name${counter}`);
                document.getElementById(print_loc).appendChild(makeDiv);
                makeDiv.appendChild(makeP);


                makeP.innerHTML += `${itemPrice}: ${iterateObject[itemPrice]}`;
                makeP.innerHTML += `<hr class="bg-dark" />`;

            }
        }
        if(typeof(iterateObject[itemPrice]) == "object") {
            price += getTotalPrice(iterateObject[itemPrice], null, print, print_loc);
        }
        //increase counter
        counter++;
    });
...
function populateExists() {
    sessionStorage.group_book = group_book.users.primaryuser.firstname;
    sessionStorage.group_book.users = group_book.users.primaryuser.lastname;
    if(sessionStorage.length <= 0) {
        sessionStorage.group_book.user = group_book.users;
    }
    console.log(sessionStorage.group_book.users);
}
