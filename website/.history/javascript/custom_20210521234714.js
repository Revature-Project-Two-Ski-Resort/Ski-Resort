...
function addpersonelement(iterateObject, elemID) {
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <input value="${iterateObject.firstname}" maxlength=35 oninput="addPerson(this.value, '${elemID}', 'firstname');" type="text" class="form-control form-element" id="firstname${itemcounter}" name="firstname${itemcounter}" required>
        ...
        <div class="form-group col-md-4">
            ...
            <input value="${iterateObject.middlename}" maxlength=4 oninput="addPerson(this.value, 'user${itemcounter}', 'middlename');" type="text" class="form-control form-element" id="middlename${itemcounter}" name="middlename${itemcounter}">
            <div class="invalid-feedback">
        ...
        <div class="form-group col-md-4">
            ...
            <input value="${iterateObject.lastname}" type="text" oninput="addPerson(this.value, 'user${itemcounter}', 'lastname');" maxlength=35 class="form-control form-element" id="lastname${itemcounter}" name="lastname${itemcounter}" required>
            <div class="invalid-feedback">
    ...
    <div class="form-row">
        <div class="form-group col-md-3">
            ...
            <input value="${iterateObject.age}" type="number" oninput="addPerson(this.value, 'user${itemcounter}', 'age');" min=0 max=150 step="1" placeholder="Age" class="form-control form-element" id="primaryAge${itemcounter}" name="primaryAge${itemcounter}" aria-label="Please enter your age" required />
            <div class="invalid-feedback">
        ...
        <div class="form-group col-sm-9">
            ...
            <div class="form-row">
                <input value="${iterateObject.lvl}" type="number" oninput="addPerson(this.value, 'user${itemcounter}', 'lvl');" min=1 max=5 step="1" placeholder="5=expert" value=1 class="form-control col-md-7 form-element" id="primarySkill${itemcounter}" name="primarySkill${itemcounter}" aria-label="Please enter your skill level" />
                <div class="col-md-5">
