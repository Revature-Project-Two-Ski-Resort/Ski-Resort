...
function addpersonelement(iterateObject) {
    itemcounter = 1;
    ...
    <div class="form-row">
        <div class="form-group col-md-4">
            <label value="${iterateObject.firstname}" for="firstname${itemcounter}">*First Name</label>
...
function popPeople(iterateObject) {
    Object.keys(iterateObject).forEach(function (itemPrice) {
        if(itemPrice != "primaryuser") {
            addpersonelement(iterateObject[itemPrice]);
        }
    });
}
